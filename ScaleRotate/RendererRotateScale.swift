...
class Renderer:NSObject{
    ...
    init(metalView:MTKView){
        ...
        let distanceVector = float4(vertices.last!.x, vertices.last!.y, vertices.last!.z, 1)
        ...
        //inverse allows you to get the center in normalised coordinate space
        
        //move every vertex by the vector of the *last vertex from the world center (0,5, 0,5)
        // rotate the vertex
        // translate the vertexes back into position
        tm3 = translate * rotate * translate.inverse
